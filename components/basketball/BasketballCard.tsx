      ...
      <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-orange-900 rounded-xl shadow-card p-6 mb-4 hover:shadow-elevated transition-all overflow-hidden active:scale-[0.98] border border-orange-500/20">
        ...
        <div className="relative flex items-center justify-between mb-5 z-10">
          ...
          <div className="flex flex-col items-center gap-3 flex-1">
            ...
            <div className="w-16 h-1.5 bg-gradient-to-r from-orange-500 to-red-500 rounded-full shadow-soft"></div>
          </div>
          
          {/* VS Badge */}
          <div className="px-5">
            <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold text-sm px-4 py-2 rounded-full shadow-card">
              VS
            </div>
          </div>
        ...
        <div className="flex justify-center mb-4 relative z-10">
          <div className="flex items-center gap-1">
            <div className="w-10 h-10 rounded-full border-2 border-orange-400 flex items-center justify-center bg-orange-500/10 shadow-soft">
