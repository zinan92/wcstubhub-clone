...
async function main() {
  ...
  await prisma.event.create({
    data: {
      ...
      artistImageUrl: 'https://picsum.photos/seed/taylorswift/400/400',
  ...
  await prisma.event.create({
    data: {
      ...
      artistImageUrl: 'https://picsum.photos/seed/edsheeran/400/400',
  ...
  await prisma.event.create({
    data: {
      ...
      artistImageUrl: 'https://picsum.photos/seed/theweeknd/400/400',
  ...
  await prisma.event.create({
    data: {
      ...
      type: 'concert',
      artistName: 'Beyoncé',
      artistImageUrl: 'https://picsum.photos/seed/beyonce/400/400',
